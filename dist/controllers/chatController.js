...
const createMessage = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const newMessage = yield chatService_1.default.createMessage(text, sender, receiver);
...
const getMessages = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const messages = yield chatService_1.default.getAllMessages(sender, receiver);
